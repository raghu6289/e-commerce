    ...
    <div className="pt-10 transition-opacity duration-500 ease-in border-t-2 opacity-100">
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 px-6 py-6 text-sm text-gray-500 border">
          <p>
            Elevate your hair care routine with our meticulously crafted
            Trendify Hair Oils. Formulated with a perfect balance of nourishment
            and shine, Trendify Hair Oils are made from premium, natural
            ingredients that ensure both vitality and softness.
          </p>
          <p>
            Whether you're restoring dry ends or adding a glossy finish to your
            locks, Trendify Hair Oils offer unparalleled versatility. Its rich
            blend of oils, coupled with its fast-absorbing formula, makes it an
            essential part of your daily hair care routine. Don’t miss out on
            the chance to indulge in hair that feels as luxurious as it
            looks—experience the difference today.
          </p>
        </div>
      </div>
